...
class SpinnerGroupSeventyOneAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerGroupSeventyOneModel>
) : ArrayAdapter<SpinnerGroupSeventyOneModel>(mContext, layoutResource, allItems) {
